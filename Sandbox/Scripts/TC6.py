...
CASE_CODE = "TC6"
CASE_DIR = SCRIPT_DIR.parent / "vortexSphere_Williamson_TC6"

RUN_DIRS = [
    Path(item).expanduser()
    for item in os.environ.get("TC6_RUN_DIRS", "").split(os.pathsep)
    if item
] or [CASE_DIR / "run_standard"]
