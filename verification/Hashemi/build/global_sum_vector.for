...
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE GLOBAL\_SUM\_VECTOR\Real*8
C     | o Handle sum for Real*8 vector.
C     *==========================================================*
...
C--   write local sum into shared-buffer array (+ convert Real*8 to r8)
       DO j = 1,nLoc
        DO bj = myByLo(myThid), myByHi(myThid)
         DO bi = myBxLo(myThid), myBxHi(myThid)
          shareBufGSVec(bi,bj,j) = tiledVec(bi,bj,j+j0)
...
C--   set result for every threads (+ convert back r8 to Real*8)
       DO j=1,nLoc
        sumVec(j+j0) = shareGSVector(j)
       ENDDO
...
C     !DESCRIPTION:
C     *==========================================================*
C     | SUBROUTINE GLOBAL\_SUM\_VEC\_ALT\Real*8
C     | o Handle sum for Real*8 vector.
C     *==========================================================*
