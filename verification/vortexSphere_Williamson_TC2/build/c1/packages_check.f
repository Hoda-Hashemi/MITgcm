...
C---  Continue with standard packages (with standard usePKG flag)
      ...
      IF ( useSHAP_FILT ) CALL PACKAGES_ERROR_MSG(
     &                  'SHAP_FILT', ' ', myThid )
     ...
     &   CALL PACKAGES_ERROR_MSG( 'ZONAL_FILT', ' ', myThid )
      ...
      IF ( useDOWN_SLOPE ) CALL PACKAGES_ERROR_MSG(
     &                  'DOWN_SLOPE', ' ', myThid )
     ...
     &                  'BULK_FORCE', 'useBulkForce=.T.', myThid )
      ...
      IF ( useCheapAML ) CALL PACKAGES_ERROR_MSG(
     &                  'CheapAML', ' ', myThid )

      IF ( useFLT ) CALL PACKAGES_ERROR_MSG( 'FLT', ' ', myThid )


      IF ( usePTRACERS ) CALL PACKAGES_ERROR_MSG(
     &                  'PTRACERS', ' ', myThid )
      ...
      IF ( useOffLine ) CALL PACKAGES_ERROR_MSG(
     &                  'OffLine', ' ', myThid )
      ...
      IF ( useSALT_PLUME ) CALL PACKAGES_ERROR_MSG(
     &                  'SALT_PLUME', ' ', myThid )

      IF ( useShelfIce ) CALL PACKAGES_ERROR_MSG(
     &                    'ShelfIce', ' ', myThid )
     ...
     &                  'STEEP_ICECAVITY', 'useSTIC=.T.', myThid )
      ...
      IF ( useStreamIce ) CALL PACKAGES_ERROR_MSG(
     &                  'StreamIce', ' ', myThid )

      IF ( useICEFRONT ) CALL PACKAGES_ERROR_MSG(
     &                  'ICEFRONT', ' ', myThid )
      ...
      IF ( useAtm_Phys ) CALL PACKAGES_ERROR_MSG(
     &                  'Atm_Phys', ' ', myThid )

      IF ( useFizhi ) CALL PACKAGES_ERROR_MSG( 'Fizhi', ' ', myThid )

      IF ( useGridAlt ) CALL PACKAGES_ERROR_MSG(
     &                  'GridAlt', ' ', myThid )
      ...
      IF ( usePROFILES ) CALL PACKAGES_ERROR_MSG(
     &                  'PROFILES', ' ', myThid )

      IF ( useOBSFIT ) CALL PACKAGES_ERROR_MSG( 'OBSFIT', ' ', myThid )
     ...
     &                  'NEST_PARENT', ' ', myThid )
      ...
      IF ( useRunClock ) CALL PACKAGES_ERROR_MSG(
     &                  'RunClock', ' ', myThid )
