...
C     MYPA 3-dim. fields
      Real*8 myPa_StatScal1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 myPa_StatScal2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 myPa_StatVelU (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 myPa_StatVelV (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      COMMON /MYPA_STATE_3D/
     &    myPa_StatScal1, myPa_StatScal2,
     &    myPa_StatVelU,  myPa_StatVelV
C     MYPA 2-dim. fields
      Real*8 myPa_Surf1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      Real*8 myPa_Surf2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      COMMON /MYPA_STATE_2D/
     &    myPa_Surf1, myPa_Surf2

      Real*8 myPa_TendScal1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 myPa_TendScal2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 myPa_TendVelU (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      Real*8 myPa_TendVelV (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
...
C     3-dim.
        DO k=1,Nr
         DO j=1-OLy,sNy+OLy
          DO i=1-OLx,sNx+OLx
           myPa_StatScal1(i,j,k,bi,bj) = 0.D0
           myPa_StatScal2(i,j,k,bi,bj) = 0.D0
           myPa_StatVelU (i,j,k,bi,bj) = 0.D0
           myPa_StatVelV (i,j,k,bi,bj) = 0.D0
           myPa_TendScal1(i,j,k,bi,bj) = 0.D0
           myPa_TendScal2(i,j,k,bi,bj) = 0.D0
           myPa_TendVelU (i,j,k,bi,bj) = 0.D0
           myPa_TendVelV (i,j,k,bi,bj) = 0.D0
          ENDDO
         ENDDO
        ENDDO
...
C     2-dim.
        DO j=1-OLy,sNy+OLy
         DO i=1-OLx,sNx+OLx
          myPa_Surf1(i,j,bi,bj) = 0.D0
          myPa_Surf2(i,j,bi,bj) = 0.D0
         ENDDO
        ENDDO
