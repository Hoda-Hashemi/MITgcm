...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Plot vortexSphere_mitgcm_Poisson PSI output from PsiOcean.csv."
    )
    parser.add_argument(
        "--input",
        default="verification/vortexSphere_mitgcm_Poisson/output/Fortran/solution/PsiOcean.csv",
        help="Path to PsiOcean.csv",
    )
    parser.add_argument(
        "--outdir",
        default="verification/vortexSphere_mitgcm_Poisson/results",
